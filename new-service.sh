...
wget -q -O "$SERVICE_FILE" 'https://raw.githubusercontent.com/henriquemenezes/sample-service-script/master/service.sh' || { echo 'ERROR: Could not retreive service.sh from github'; exit 1;}
